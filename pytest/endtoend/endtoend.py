...
python3 endtoend/endtoend.py
    ...
    --rpc-server-addr rpc.testnet.hkt.org
    --rpc-server-port 80
    --metrics-port 3040
"""
import argparse
...
balance_gauge = prometheus_client.Gauge(
    'hkt_e2e_account_balance',
    'Balance of the test accounts running an end-to-end test. Measured in yoctohkt.',
    ['account'])
...
def do_ping(account, rpc_server):
    ...
    balance = mocknet_helpers.retry_and_ignore_errors(
        lambda: mocknet_helpers.get_amount_yoctohkt(
