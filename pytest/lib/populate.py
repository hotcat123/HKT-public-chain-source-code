...
def genesis_populate(hkt_root, additional_accounts, node_dir):
    subprocess.check_call(
        (join(hkt_root, 'genesis-populate'), '--additional-accounts-num',
...
def genesis_populate_all(hkt_root, additional_accounts, node_dirs):
    genesis_populate(hkt_root, additional_accounts, node_dirs[0])
