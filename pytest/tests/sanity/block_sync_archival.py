...
class Cluster:
    ...
    def __init__(self):
        ...
        self._hkt_root, self._node_dirs = cluster.init_cluster(
            num_nodes=1,
            num_observers=2,
            num_shards=1,
            config=self._config,
...
def get_metrics(node_name: str,
    ...
    Returns:
        ...
        hkt_partial_encoded_chunk_request_processing_time_count Prometheus
        metric.
    """
    ...
    metric_name = 'hkt_partial_encoded_chunk_request_processing_time'
    histogram = next(
        (metric
