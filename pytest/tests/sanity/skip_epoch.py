...
# Warn: this test may not clean up ~/.hkt if fails early
...
node3 = spin_up_node(config, hkt_root, node_dirs[2], 2, boot_node=boot_node)
node4 = spin_up_node(config, hkt_root, node_dirs[3], 3, boot_node=boot_node)
observer = spin_up_node(config, hkt_root, node_dirs[4], 4, boot_node=boot_node)
...
node2 = spin_up_node(config, hkt_root, node_dirs[1], 1, boot_node=boot_node)
