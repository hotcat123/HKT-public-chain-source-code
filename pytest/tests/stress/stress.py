...
#  [v] `staking`: runs staking transactions for validators. Presently the test doesn't track staking invariants, relying on asserts in the hktcore.
...
def doit(s, n, N, k, monkeys, timeout):
    ...
    boot_node = spin_up_node(config, hkt_root, node_dirs[0], 0, proxy=proxy)
