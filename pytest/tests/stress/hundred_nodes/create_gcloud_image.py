...
git clone --single-branch --branch {branch} https://github.com/hktprotocol/hktcore.git hktcore
cd hktcore
cargo build -p hktd --release {additional_flags}
''')

assert p.returncode == 0

logger.info('hkt built')
