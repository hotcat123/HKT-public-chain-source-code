...
def function_call(account, i, node_account):
    if random.randint(0, 1) == 0:
        s = f'{{"token_account_id": "token2.hkt"}}'
        logger.info(
...
def initialize_skyward_contract(node_account_id, pk, sk):
    ...
    s = f'{{"skyward_token_id": "{mocknet.SKYWARD_TOKEN_ACCOUNT}", "skyward_vesting_schedule":[{{"start_timestamp":0,"end_timestamp":1999999999,"amount":"99999999999"}}], "listing_fee_hkt": "10000000000000000000000000", "w_hkt_token_id":"{mocknet.MASTER_ACCOUNT}"}}'
