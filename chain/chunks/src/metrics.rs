use hkt_o11y::metrics::exponential_buckets;
use once_cell::sync::Lazy;

pub static PARTIAL_ENCODED_CHUNK_REQUEST_PROCESSING_TIME: Lazy<hkt_o11y::metrics::HistogramVec> =
    Lazy::new(|| {
        hkt_o11y::metrics::try_create_histogram_vec(
            "hkt_partial_encoded_chunk_request_processing_time",
            concat!(
...
pub static DISTRIBUTE_ENCODED_CHUNK_TIME: Lazy<hkt_o11y::metrics::HistogramVec> =
    Lazy::new(|| {
        hkt_o11y::metrics::try_create_histogram_vec(
            "hkt_distribute_encoded_chunk_time",
            concat!(
