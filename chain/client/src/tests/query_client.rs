...
use hkt_primitives::types::{BlockId, BlockReference, EpochId};
...
use hkt_primitives::views::{FinalExecutionOutcomeViewEnum, QueryRequest, QueryResponseKind};
...
fn test_state_request() {
    run_actix(async {
        ...
        hkt_network::test_utils::wait_or_panic(50000);
    });
}
...
fn test_garbage_collection() {
    ...
    run_actix(async {
        ...
        hkt_network::test_utils::wait_or_panic(block_prod_time * target_height * 2 + 2000);
    })
}
