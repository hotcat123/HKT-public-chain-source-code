...
pub(crate) static IS_VALIDATOR: Lazy<IntGauge> = Lazy::new(|| {
    try_create_int_gauge("hkt_is_validator", "Bool to denote if it is currently validating")
        .unwrap()
});

pub(crate) static RECEIVED_BYTES_PER_SECOND: Lazy<IntGauge> = Lazy::new(|| {
    try_create_int_gauge(
        "hkt_received_bytes_per_second",
...
pub(crate) static BLOCKS_PER_MINUTE: Lazy<IntGauge> = Lazy::new(|| {
    try_create_int_gauge("hkt_blocks_per_minute", "Blocks produced per minute").unwrap()
});

// Deprecated.
pub(crate) static CHUNKS_PER_BLOCK_MILLIS: Lazy<IntGauge> = Lazy::new(|| {
    try_create_int_gauge(
        "hkt_chunks_per_block_millis",
...
pub(crate) static CPU_USAGE: Lazy<IntGauge> =
    Lazy::new(|| try_create_int_gauge("hkt_cpu_usage_ratio", "Percent of CPU usage").unwrap());

pub(crate) static MEMORY_USAGE: Lazy<IntGauge> = Lazy::new(|| {
    try_create_int_gauge("hkt_memory_usage_bytes", "Amount of RAM memory usage").unwrap()
});

pub(crate) static GC_TIME: Lazy<Histogram> = Lazy::new(|| {
    try_create_histogram("hkt_gc_time", "Time taken to do garbage collection").unwrap()
});
...
pub(crate) static VALIDATORS_CHUNKS_PRODUCED: Lazy<IntGaugeVec> = Lazy::new(|| {
    try_create_int_gauge_vec(
        "hkt_validators_chunks_produced",
...
pub(crate) static VALIDATORS_CHUNKS_EXPECTED: Lazy<IntGaugeVec> = Lazy::new(|| {
    try_create_int_gauge_vec(
        "hkt_validators_chunks_expected",
...
pub(crate) static VALIDATORS_BLOCKS_PRODUCED: Lazy<IntGaugeVec> = Lazy::new(|| {
    try_create_int_gauge_vec(
        "hkt_validators_blocks_produced",
...
pub(crate) static VALIDATORS_BLOCKS_EXPECTED: Lazy<IntGaugeVec> = Lazy::new(|| {
    try_create_int_gauge_vec(
        "hkt_validators_blocks_expected",
...
pub(crate) static SYNC_STATUS: Lazy<IntGauge> =
    Lazy::new(|| try_create_int_gauge("hkt_sync_status", "Node sync status").unwrap());

pub(crate) static EPOCH_HEIGHT: Lazy<IntGauge> = Lazy::new(|| {
    try_create_int_gauge("hkt_epoch_height", "Height of the epoch at the head of the blockchain")
        .unwrap()
});

pub(crate) static PROTOCOL_UPGRADE_BLOCK_HEIGHT: Lazy<IntGauge> = Lazy::new(|| {
    try_create_int_gauge(
        "hkt_protocol_upgrade_block_height",
...
pub(crate) static PEERS_WITH_INVALID_HASH: Lazy<IntGauge> = Lazy::new(|| {
    try_create_int_gauge("hkt_peers_with_invalid_hash", "Number of peers that are on invalid hash")
        .unwrap()
});

pub(crate) static CHUNK_SKIPPED_TOTAL: Lazy<IntCounterVec> = Lazy::new(|| {
    try_create_int_counter_vec(
        "hkt_chunk_skipped_total",
...
pub(crate) static CHUNK_PRODUCER_BANNED_FOR_EPOCH: Lazy<IntCounter> = Lazy::new(|| {
    try_create_int_counter(
        "hkt_chunk_producer_banned_for_epoch",
...
pub(crate) static CHUNK_DROPPED_BECAUSE_OF_BANNED_CHUNK_PRODUCER: Lazy<IntCounter> =
    Lazy::new(|| {
        try_create_int_counter(
            "hkt_chunk_dropped_because_of_banned_chunk_producer",
...
pub(crate) static PARTIAL_ENCODED_CHUNK_RESPONSE_DELAY: Lazy<Histogram> = Lazy::new(|| {
    try_create_histogram(
        "hkt_partial_encoded_chunk_response_delay",
...
pub(crate) static CLIENT_MESSAGES_PROCESSING_TIME: Lazy<HistogramVec> = Lazy::new(|| {
    try_create_histogram_vec(
        "hkt_client_messages_processing_time",
...
pub(crate) static CLIENT_TRIGGER_TIME_BY_TYPE: Lazy<HistogramVec> = Lazy::new(|| {
    try_create_histogram_vec(
        "hkt_client_triggers_time_by_type",
...
pub(crate) static GAS_USED: Lazy<Counter> = Lazy::new(|| {
    try_create_counter("hkt_gas_used", "Gas used by processed blocks, measured in gas").unwrap()
});

pub(crate) static BLOCKS_PROCESSED: Lazy<IntCounter> = Lazy::new(|| {
    try_create_int_counter("hkt_blocks_processed", "Number of processed blocks").unwrap()
});

pub(crate) static CHUNKS_PROCESSED: Lazy<IntCounter> = Lazy::new(|| {
    try_create_int_counter("hkt_chunks_processed", "Number of processed chunks").unwrap()
});

pub(crate) static GAS_PRICE: Lazy<Gauge> = Lazy::new(|| {
    try_create_gauge("hkt_gas_price", "Gas price of the latest processed block").unwrap()
});

pub(crate) static BALANCE_BURNT: Lazy<Counter> = Lazy::new(|| {
    try_create_counter("hkt_balance_burnt", "Balance burnt by processed blocks in hkt tokens")
        .unwrap()
});

pub(crate) static TOTAL_SUPPLY: Lazy<Gauge> = Lazy::new(|| {
    try_create_gauge("hkt_total_supply", "Gas price of the latest processed block").unwrap()
});

pub(crate) static FINAL_BLOCK_HEIGHT: Lazy<IntGauge> = Lazy::new(|| {
    try_create_int_gauge("hkt_final_block_height", "Last block that has full BFT finality")
        .unwrap()
});

pub(crate) static FINAL_DOOMSLUG_BLOCK_HEIGHT: Lazy<IntGauge> = Lazy::new(|| {
    try_create_int_gauge(
        "hkt_final_doomslug_block_height",
...
static NODE_DB_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    try_create_int_gauge("hkt_node_db_version", "DB version used by the node").unwrap()
});
...
pub(crate) static TRANSACTION_RECEIVED_VALIDATOR: Lazy<IntGauge> = Lazy::new(|| {
    try_create_int_gauge("hkt_transaction_received_validator", "Validator received a transaction")
        .unwrap()
});

pub(crate) static TRANSACTION_RECEIVED_NON_VALIDATOR: Lazy<IntGauge> = Lazy::new(|| {
    try_create_int_gauge(
        "hkt_transaction_received_non_validator",
...
pub(crate) static TRANSACTION_RECEIVED_NON_VALIDATOR_FORWARDED: Lazy<IntGauge> = Lazy::new(|| {
    try_create_int_gauge(
        "hkt_transaction_received_non_validator_forwarded",
...
pub(crate) static NODE_PROTOCOL_VERSION: Lazy<IntGauge> = Lazy::new(|| {
    try_create_int_gauge("hkt_node_protocol_version", "Max protocol version supported by the node")
        .unwrap()
});

pub static PRODUCE_CHUNK_TIME: Lazy<hkt_o11y::metrics::HistogramVec> = Lazy::new(|| {
    try_create_histogram_vec(
        "hkt_produce_chunk_time",
...
pub static VIEW_CLIENT_MESSAGE_TIME: Lazy<hkt_o11y::metrics::HistogramVec> = Lazy::new(|| {
    try_create_histogram_vec(
        "hkt_view_client_messages_processing_time",
...
pub static PRODUCE_AND_DISTRIBUTE_CHUNK_TIME: Lazy<hkt_o11y::metrics::HistogramVec> =
    Lazy::new(|| {
        try_create_histogram_vec(
            "hkt_produce_and_distribute_chunk_time",
...
/// Exports hktd, protocol and database versions via Prometheus metrics.
///
...
/// `hktd_version` argument.
pub(crate) fn export_version(hktd_version: &hkt_primitives::version::Version) {
    NODE_PROTOCOL_VERSION.set(hkt_primitives::version::PROTOCOL_VERSION.into());
    NODE_DB_VERSION.set(hkt_store::version::DB_VERSION.into());
    NODE_BUILD_INFO.reset();
    NODE_BUILD_INFO
        .with_label_values(&[
            &hktd_version.version,
            &hktd_version.build,
            &hktd_version.rustc_version,
        ])
        .inc();
}
