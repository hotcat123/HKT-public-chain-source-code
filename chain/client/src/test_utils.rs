...
use hkt_crypto::{InMemorySigner, KeyType, PublicKey};
...
use hkt_primitives::block::{ApprovalInner, Block, GenesisId};
...
use hkt_primitives::sharding::{EncodedShardChunk, PartialEncodedChunk, ReedSolomonWrapper};
...
use hkt_chain::chain::{do_apply_chunks, BlockCatchUpRequest, StateSplitRequest};
use hkt_client_primitives::types::Error;
use hkt_network::types::{
...
use hkt_primitives::time::{Clock, Instant};
...
impl Client {
    ...
    ) -> Result<Vec<CryptoHash>, hkt_chain::Error> {
...

                    {
                        ...
                        let peers: Vec<_> = key_pairs1
                            ...
                            .map(|(i, peer_info)| ConnectedPeerInfo {
                                ...
                                last_time_peer_requested: hkt_network_primitives::time::Instant::now(),
                                last_time_received_message: hkt_network_primitives::time::Instant::now(),
                                connection_established_time: hkt_network_primitives::time::Instant::now(),
...
/// This environment can simulate hkt nodes without network and it can be configured to use different runtimes.
pub struct TestEnv {
