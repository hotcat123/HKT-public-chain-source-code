...
use hkt_primitives::epoch_manager::epoch_info::{EpochInfo, EpochSummary};
use hkt_primitives::epoch_manager::{
...
use hkt_primitives::version::{ProtocolVersion, UPGRADABILITY_FIX_PROTOCOL_VERSION};
use hkt_primitives::views::{
    CurrentEpochValidatorInfo, EpochValidatorInfo, NextEpochValidatorInfo, ValidatorKickoutView,
};
use hkt_store::{DBCol, Store, StoreUpdate};
...
impl EpochManager {
    ...
    fn collect_blocks_info(
        ...
        // Implements https://github.com/hktprotocol/NEPs/pull/64/files#diff-45f773511fe4321b446c3c4226324873R76
...
impl EpochManager {
    ...
    fn is_next_block_in_next_epoch(&self, block_info: &BlockInfo) -> Result<bool, EpochError> {
        ...
        if epoch_length <= 3 {
            ...
            // https://github.com/hktprotocol/hktcore/issues/2522
