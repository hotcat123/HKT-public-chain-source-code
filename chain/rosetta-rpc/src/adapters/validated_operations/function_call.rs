...
pub(crate) struct FunctionCallOperation {
    ...
    pub(crate) attached_gas: hkt_primitives::types::Gas,
    pub(crate) attached_amount: hkt_primitives::types::Balance,
}
    ...
    fn into_operation(
        ...
        crate::models::Operation {
            ...
            amount: if self.attached_amount > 0 {
                Some(crate::models::Amount::from_yoctohkt(self.attached_amount))
            } else {
                None
            },
