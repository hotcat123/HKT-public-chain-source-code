...
use hkt_client::ViewClientActor;
...
/// hkt Protocol defines initial state in genesis records and treats the first
...
async fn convert_genesis_records_to_transaction(
    ...
    block: &hkt_primitives::views::BlockView,
    ...
    genesis.for_each_record(|record| {
        if let hkt_primitives::state_record::StateRecord::Account { account_id, .. } = record {
    ...
    let genesis_accounts: std::collections::BTreeMap<_, _> = crate::utils::query_accounts(
        &hkt_primitives::types::BlockId::Hash(block.header.hash).into(),
    ...
    for (account_id, account) in genesis_accounts {
        ...
        if account_balances.liquid != 0 {
            operations.push(crate::models::Operation {
                ...
                amount: Some(crate::models::Amount::from_yoctohkt(account_balances.liquid)),
        ...
        if account_balances.liquid_for_storage != 0 {
            operations.push(crate::models::Operation {
                ...
                amount: Some(crate::models::Amount::from_yoctohkt(
        ...
        if account_balances.locked != 0 {
            operations.push(crate::models::Operation {
                ...
                amount: Some(crate::models::Amount::from_yoctohkt(account_balances.locked)),
                type_: crate::models::OperationType::Transfer,
                status: Some(crate::models::OperationStatusKind::Success),
                metadata: None,
            });
...
pub(crate) async fn convert_block_to_transactions(
    ...
    let state_changes = view_client_addr
        .send(hkt_client::GetStateChangesInBlock { block_hash: block.header.hash })
        .await?
        .unwrap();
    ...
    let touched_account_ids = state_changes
        .into_iter()
        .filter_map(|x| {
            if let hkt_primitives::views::StateChangeKindView::AccountTouched { account_id } = x {
                Some(account_id)
            } else {
                None
            }
    ...
    let prev_block_id = hkt_primitives::types::BlockReference::from(
        hkt_primitives::types::BlockId::Hash(block.header.prev_hash),
    );
    ...
    let accounts_changes = view_client_addr
        .send(hkt_client::GetStateChanges {
            block_hash: block.header.hash,
            state_changes_request:
                hkt_primitives::views::StateChangesRequestView::AccountChanges {
...
/// and from hkt Actions (see From and TryFrom implementations).
///
/// A single hkt Action expands into 1-3 Rosetta Operations. This
/// relation is bijective (hkt Actions -> Rosetta Operations ->
/// hkt Actions == original hkt Actions).
///
...
#[derive(Debug, Clone)]
pub struct hktActions {
    pub sender_account_id: hkt_primitives::types::AccountId,
    pub receiver_account_id: hkt_primitives::types::AccountId,
    pub actions: Vec<hkt_primitives::transaction::Action>,
}

impl From<hktActions> for Vec<crate::models::Operation> {
    /// Convert hkt Actions to Rosetta Operations. It never fails.
    fn from(hkt_actions: hktActions) -> Self {
        let hktActions { sender_account_id, receiver_account_id, actions } = hkt_actions;
        ...
        for action in actions {
            match action {
                hkt_primitives::transaction::Action::CreateAccount(_) => {
                ...
                hkt_primitives::transaction::Action::DeleteAccount(action) => {
                ...
                hkt_primitives::transaction::Action::AddKey(action) => {
                ...
                hkt_primitives::transaction::Action::DeleteKey(action) => {
                ...
                hkt_primitives::transaction::Action::Transfer(action) => {
                    let transfer_amount = crate::models::Amount::from_yoctohkt(action.deposit);
                ...
                hkt_primitives::transaction::Action::Stake(action) => {
                    operations.push(
                ...
                hkt_primitives::transaction::Action::DeployContract(action) => {
                ...
                hkt_primitives::transaction::Action::FunctionCall(action) => {
                    let attached_amount = crate::models::Amount::from_yoctohkt(action.deposit);
...
impl TryFrom<Vec<crate::models::Operation>> for hktActions {
    type Error = crate::errors::ErrorKind;

    /// Convert Rosetta Operations to hkt Actions.
    ///
    /// See the inverted implementation of From<hktActions> for Vec<Operations>
    /// above to understand how a single hkt Action is represented with Rosetta
    ...
    fn try_from(operations: Vec<crate::models::Operation>) -> Result<Self, Self::Error> {
        ...
        while let Some(tail_operation) = operations.next() {
            match tail_operation.type_ {
                crate::models::OperationType::CreateAccount => {
                    ...
                    actions.push(hkt_primitives::transaction::CreateAccountAction {}.into())
                }
                ...
                crate::models::OperationType::RefundDeleteAccount => {
                    ...
                    actions.push(
                        hkt_primitives::transaction::DeleteAccountAction {
                ...
                crate::models::OperationType::AddKey => {
                    ...
                    actions.push(
                        hkt_primitives::transaction::AddKeyAction {
                            access_key: hkt_primitives::account::AccessKey::full_access(),
                            public_key,
                        }
                        .into(),
                    )
                ...
                crate::models::OperationType::DeleteKey => {
                    ...
                    actions
                        .push(hkt_primitives::transaction::DeleteKeyAction { public_key }.into())
                }
                ...
                crate::models::OperationType::Transfer => {
                    ...
                    actions.push(
                        hkt_primitives::transaction::TransferAction {
                ...
                crate::models::OperationType::Stake => {
                    ...
                    actions.push(
                        hkt_primitives::transaction::StakeAction {
                ...
                crate::models::OperationType::DeployContract => {
                    ...
                    actions.push(
                        hkt_primitives::transaction::DeployContractAction {
                ...
                crate::models::OperationType::FunctionCall => {
                    ...
                    actions.push(
                        hkt_primitives::transaction::FunctionCallAction {
        ...
        let receiver_account_id: hkt_primitives::types::AccountId = receiver_account_id
            .into_inner()
            .ok_or_else(|| {
...
mod tests {
    ...
    use hkt_client::test_utils::setup_no_network;

    #[test]
    fn test_convert_block_changes_to_transactions() {
        run_actix(async {
            let runtime_config = hkt_primitives::runtime::config::RuntimeConfig::test();
            ...
            let block_hash = hkt_primitives::hash::CryptoHash::default();
            let nfvalidator1_receipt_processing_hash = hkt_primitives::hash::CryptoHash([1u8; 32]);
            let nfvalidator2_action_receipt_gas_reward_hash =
                hkt_primitives::hash::CryptoHash([2u8; 32]);
            let accounts_changes = vec![
                hkt_primitives::views::StateChangeWithCauseView {
                    cause: hkt_primitives::views::StateChangeCauseView::ValidatorAccountsUpdate,
                    value: hkt_primitives::views::StateChangeValueView::AccountUpdate {
                        account_id: "nfvalidator1.hkt".parse().unwrap(),
                        account: hkt_primitives::views::AccountView {
                            amount: 5000000000000000000,
                            code_hash: hkt_primitives::hash::CryptoHash::default(),
                ...
                hkt_primitives::views::StateChangeWithCauseView {
                    cause: hkt_primitives::views::StateChangeCauseView::ReceiptProcessing {
                ...
                hkt_primitives::views::StateChangeWithCauseView {
                    cause: hkt_primitives::views::StateChangeCauseView::ValidatorAccountsUpdate,
                    value: hkt_primitives::views::StateChangeValueView::AccountUpdate {
                        account_id: "nfvalidator2.hkt".parse().unwrap(),
                        account: hkt_primitives::views::AccountView {
                ...
                hkt_primitives::views::StateChangeWithCauseView {
                    cause: hkt_primitives::views::StateChangeCauseView::ActionReceiptGasReward {
            ...
            accounts_previous_state.insert(
                "nfvalidator1.hkt".parse().unwrap(),
                hkt_primitives::views::AccountView {
                    amount: 4000000000000000000,
                    code_hash: hkt_primitives::hash::CryptoHash::default(),
                    locked: 400000000000000000000000000000,
                    storage_paid_at: 0,
    ...
    #[test]
    fn test_hkt_actions_bijection() {
        let create_account_actions =
            vec![hkt_primitives::transaction::CreateAccountAction {}.into()];
        let delete_account_actions = vec![hkt_primitives::transaction::DeleteAccountAction {
            beneficiary_id: "beneficiary.hkt".parse().unwrap(),
        }
        .into()];
        let add_key_actions = vec![hkt_primitives::transaction::AddKeyAction {
            access_key: hkt_primitives::account::AccessKey::full_access(),
            public_key: hkt_crypto::SecretKey::from_random(hkt_crypto::KeyType::ED25519)
                .public_key(),
        }
        .into()];
        let delete_key_actions = vec![hkt_primitives::transaction::DeleteKeyAction {
            public_key: hkt_crypto::SecretKey::from_random(hkt_crypto::KeyType::ED25519)
                .public_key(),
        }
        .into()];
        let transfer_actions = vec![hkt_primitives::transaction::TransferAction {
            deposit: hkt_primitives::types::Balance::MAX,
        }
        .into()];
        let stake_actions = vec![hkt_primitives::transaction::StakeAction {
            stake: 456,
            public_key: hkt_crypto::SecretKey::from_random(hkt_crypto::KeyType::ED25519)
                .public_key(),
        }
        .into()];
        let deploy_contract_actions = vec![hkt_primitives::transaction::DeployContractAction {
            code: b"binary-data".to_vec(),
        }
        .into()];
        let function_call_without_balance_actions =
            vec![hkt_primitives::transaction::FunctionCallAction {
        ...
        for actions in non_sir_compatible_actions.clone() {
            let hkt_actions = hktActions {
                sender_account_id: "sender.hkt".parse().unwrap(),
                receiver_account_id: "receiver.hkt".parse().unwrap(),
                actions,
            };
            println!("hkt Actions: {:#?}", hkt_actions);
            let operations: Vec<crate::models::Operation> = hkt_actions.clone().into();
            println!("Operations: {:#?}", operations);

            let hkt_actions_recreated = hktActions::try_from(operations).unwrap();

            assert_eq!(hkt_actions_recreated.sender_account_id, hkt_actions.sender_account_id);
            assert_eq!(
                hkt_actions_recreated.receiver_account_id,
                hkt_actions.receiver_account_id
            );
            assert_eq!(hkt_actions_recreated.actions, hkt_actions.actions);
        }

        let sir_compatible_actions = [non_sir_compatible_actions, vec![stake_actions]].concat();
        for actions in sir_compatible_actions {
            let hkt_actions = hktActions {
                sender_account_id: "sender-is-receiver.hkt".parse().unwrap(),
                receiver_account_id: "sender-is-receiver.hkt".parse().unwrap(),
                actions,
            };
            println!("hkt Actions: {:#?}", hkt_actions);
            let operations: Vec<crate::models::Operation> = hkt_actions.clone().into();
    ...
    #[test]
    fn test_hkt_actions_invalid_transfer_no_amount() {
        let operations = vec![crate::models::Operation {
            type_: crate::models::OperationType::Transfer,
            account: "sender.hkt".parse().unwrap(),
            amount: None,
        ...
        assert!(matches!(
            hktActions::try_from(operations),
            Err(crate::errors::ErrorKind::InvalidInput(_))
        ));
    }

    #[test]
    fn test_hkt_actions_invalid_transfer_negative_receiver_amount() {
        let operations = vec![crate::models::Operation {
            type_: crate::models::OperationType::Transfer,
            account: "sender.hkt".parse().unwrap(),
            amount: Some(-crate::models::Amount::from_yoctohkt(1)),
            operation_identifier: crate::models::OperationIdentifier::new(&[]),
            related_operations: None,
            status: None,
            metadata: None,
    ...
    #[test]
    fn test_hkt_actions_invalid_transfer_mismatching_amount() {
        let sender_transfer_operation_id =
        ...
        let operations = vec![
            crate::models::Operation {
                type_: crate::models::OperationType::Transfer,
                account: "sender.hkt".parse().unwrap(),
                amount: Some(-crate::models::Amount::from_yoctohkt(2)),
            ...
            crate::models::Operation {
                type_: crate::models::OperationType::Transfer,
                account: "receiver.hkt".parse().unwrap(),
                amount: Some(crate::models::Amount::from_yoctohkt(1)),
    ...
    #[test]
    fn test_hkt_actions_invalid_transfer_mismatching_sign_amount() {
        let sender_transfer_operation_id =
            crate::models::OperationIdentifier { index: 0, network_index: None };
        let receiver_transfer_operation_id =
            crate::models::OperationIdentifier { index: 1, network_index: None };
    ...
    #[test]
    fn test_hkt_actions_invalid_transfer_mismatching_zero_sender_amount() {
        let sender_transfer_operation_id =
            crate::models::OperationIdentifier { index: 0, network_index: None };
        let receiver_transfer_operation_id =
            crate::models::OperationIdentifier { index: 1, network_index: None };
        ...
        let operations = vec![
            crate::models::Operation {
                type_: crate::models::OperationType::Transfer,
                account: "sender.hkt".parse().unwrap(),
                amount: Some(crate::models::Amount::from_yoctohkt(0)),
                operation_identifier: sender_transfer_operation_id.clone(),
                related_operations: None,
                status: None,
                metadata: None,
    ...
    #[test]
    fn test_hkt_actions_invalid_transfer_mismatching_zero_receiver_amount() {
        let sender_transfer_operation_id =
            crate::models::OperationIdentifier { index: 0, network_index: None };
        let receiver_transfer_operation_id =
            crate::models::OperationIdentifier { index: 1, network_index: None };
    ...
    #[test]
    fn test_hkt_actions_invalid_function_call_without_fund_amount() {
    ...
    #[test]
    fn test_hkt_actions_invalid_function_call_with_zero_fund_amount() {
        let fund_transfer_function_call_operation_id =
            crate::models::OperationIdentifier { index: 0, network_index: None };
        let initiate_function_call_operation_id =
            crate::models::OperationIdentifier { index: 1, network_index: None };
    ...
    #[test]
    fn test_hkt_actions_invalid_function_call_with_positive_fund_amount() {
        let fund_transfer_function_call_operation_id =
            crate::models::OperationIdentifier { index: 0, network_index: None };
        let initiate_function_call_operation_id =
            crate::models::OperationIdentifier { index: 1, network_index: None };
    ...
    #[test]
    fn test_hkt_actions_invalid_function_call_non_matching_amounts() {
        let fund_transfer_function_call_operation_id =
            crate::models::OperationIdentifier { index: 0, network_index: None };
        let initiate_function_call_operation_id =
            crate::models::OperationIdentifier { index: 1, network_index: None };
    ...
    #[test]
    fn test_hkt_actions_invalid_function_call_with_negative_deposit() {
        let fund_transfer_function_call_operation_id =
            crate::models::OperationIdentifier { index: 0, network_index: None };
        let initiate_function_call_operation_id =
            crate::models::OperationIdentifier { index: 1, network_index: None };
