# Rosetta API Extension for hktcore
...
Next you will need to change the `faucet` with `{"address":"<accountName>"}` in `hktprotocol-testnet.ros`. Now you are ready to run the test in testnet.
##### Mainnet
