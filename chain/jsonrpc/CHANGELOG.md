...
* Extended error structures to be more explicit. See [#2976 decision comment for reference](https://github.com/hkt/hktcore/issues/2976#issuecomment-865834617)
...
* Added `EXPERIMENTAL_tx_status` endpoint exposing receipts in addition to all
  ...
  ([#3383](https://github.com/hktprotocol/hktcore/pull/3383))
