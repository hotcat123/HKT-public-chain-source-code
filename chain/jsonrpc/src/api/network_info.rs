use hkt_client_primitives::types::NetworkInfoResponse;
use hkt_jsonrpc_primitives::types::network_info::{
    RpcKnownProducer, RpcNetworkInfoError, RpcNetworkInfoResponse, RpcPeerInfo,
};
use hkt_network_primitives::types::{KnownProducer, PeerInfo};
