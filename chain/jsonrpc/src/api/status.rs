use hkt_client_primitives::types::StatusError;
use hkt_jsonrpc_primitives::types::status::{
    RpcHealthResponse, RpcStatusError, RpcStatusResponse,
};
use hkt_primitives::views::StatusResponse;
...
impl RpcFrom<hkt_client_primitives::debug::DebugStatusResponse>
    for hkt_jsonrpc_primitives::types::status::RpcDebugStatusResponse
{
    fn rpc_from(status_response: hkt_client_primitives::debug::DebugStatusResponse) -> Self {
        Self { status_response }
    }
}
