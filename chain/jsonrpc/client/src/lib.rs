...
use hkt_jsonrpc_primitives::message::{from_slice, Message};
use hkt_jsonrpc_primitives::types::changes::{
    RpcStateChangesInBlockByTypeRequest, RpcStateChangesInBlockByTypeResponse,
};
use hkt_jsonrpc_primitives::types::validator::RpcValidatorsOrderedRequest;
use hkt_primitives::hash::CryptoHash;
use hkt_primitives::types::{AccountId, BlockId, BlockReference, MaybeBlockId, ShardId};
...
impl JsonRpcClient {
    ...
    pub fn query_by_path(
        ...
        path: String,
        data: String,
    ) -> RpcRequest<hkt_jsonrpc_primitives::types::query::RpcQueryResponse> {
        call_method(&self.client, &self.server_addr, "query", [path, data])
    }

    pub fn query(
        &self,
        request: hkt_jsonrpc_primitives::types::query::RpcQueryRequest,
    ) -> RpcRequest<hkt_jsonrpc_primitives::types::query::RpcQueryResponse> {
    ...
    pub fn EXPERIMENTAL_receipt(
        &self,
        request: hkt_jsonrpc_primitives::types::receipts::RpcReceiptRequest,
    ) -> RpcRequest<hkt_jsonrpc_primitives::types::receipts::RpcReceiptResponse> {
    ...
    pub fn EXPERIMENTAL_protocol_config(
        &self,
        request: hkt_jsonrpc_primitives::types::config::RpcProtocolConfigRequest,
    ) -> RpcRequest<hkt_jsonrpc_primitives::types::config::RpcProtocolConfigResponse> {
