...
use hkt_primitives::types::{AccountId, BlockHeight, EpochId, ShardId};
...
/// Due to implementation limits of `Graph` in `hkt-network`, we support up to 128 client.
...
mod tests {
    use super::*;
    use hkt_primitives::syncing::ShardStateSyncResponseV1;

    // NOTE: this has it's counterpart in `hkt_network::types::tests`
