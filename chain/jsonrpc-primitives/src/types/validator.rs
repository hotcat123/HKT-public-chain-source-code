...
pub type RpcValidatorsOrderedResponse =
    Vec<hkt_primitives::views::validator_stake_view::ValidatorStakeView>;
...
pub struct RpcValidatorRequest {
    #[serde(flatten)]
    pub epoch_reference: hkt_primitives::types::EpochReference,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct RpcValidatorsOrderedRequest {
    pub block_id: hkt_primitives::types::MaybeBlockId,
}

#[derive(Serialize, Deserialize, Debug)]
pub struct RpcValidatorResponse {
    #[serde(flatten)]
    pub validator_info: hkt_primitives::views::EpochValidatorInfo,
}
