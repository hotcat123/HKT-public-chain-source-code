...
pub struct RpcQueryRequest {
    ...
    #[serde(flatten)]
    pub request: hkt_primitives::views::QueryRequest,
}
...
pub struct RpcQueryResponse {
    ...
    pub block_height: hkt_primitives::types::BlockHeight,
...
pub enum QueryResponseKind {
    ViewAccount(hkt_primitives::views::AccountView),
    ViewCode(hkt_primitives::views::ContractCodeView),
    ViewState(hkt_primitives::views::ViewStateResult),
    CallResult(hkt_primitives::views::CallResult),
    AccessKey(hkt_primitives::views::AccessKeyView),
    AccessKeyList(hkt_primitives::views::AccessKeyList),
}
