...
pub struct RpcLightClientExecutionProofRequest {
    #[serde(flatten)]
    pub id: hkt_primitives::types::TransactionOrReceiptId,
    pub light_client_head: hkt_primitives::hash::CryptoHash,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct RpcLightClientNextBlockRequest {
    pub last_block_hash: hkt_primitives::hash::CryptoHash,
}

#[derive(Debug, Serialize, Deserialize)]
pub struct RpcLightClientExecutionProofResponse {
    pub outcome_proof: hkt_primitives::views::ExecutionOutcomeWithIdView,
    pub outcome_root_proof: hkt_primitives::merkle::MerklePath,
    pub block_header_lite: hkt_primitives::views::LightClientBlockLiteView,
    pub block_proof: hkt_primitives::merkle::MerklePath,
}

#[derive(Debug, Serialize)]
pub struct RpcLightClientNextBlockResponse {
    #[serde(flatten)]
    pub light_client_block: Option<Arc<hkt_primitives::views::LightClientBlockView>>,
}
