...
pub enum ChunkReference {
    BlockShardId {
        block_id: hkt_primitives::types::BlockId,
        shard_id: hkt_primitives::types::ShardId,
    },
    ChunkHash {
        chunk_id: hkt_primitives::hash::CryptoHash,
    },
}
...
pub struct RpcChunkResponse {
    #[serde(flatten)]
    pub chunk_view: hkt_primitives::views::ChunkView,
}
...
pub enum RpcChunkError {
    ...
    UnknownChunk { chunk_hash: hkt_primitives::sharding::ChunkHash },
}
