...
pub struct TelemetryConfig {
    ...
    pub reporting_interval: hkt_primitives::time::Duration,
}

fn default_reporting_interval() -> hkt_primitives::time::Duration {
    hkt_primitives::time::Duration::from_secs(10)
}
...
impl TelemetryActor {
    pub fn new(config: TelemetryConfig) -> Self {
        ...
        Self {
            ...
            last_telemetry_update: hkt_primitives::time::Instant::now().sub(reporting_interval),
        }
    }
}
