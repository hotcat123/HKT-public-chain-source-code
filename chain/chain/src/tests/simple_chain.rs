use crate::hkt_chain_primitives::error::BlockKnownError;
...
use hkt_primitives::time::MockClockGuard;
...
fn build_chain() {
    ...
    //     cargo insta test --accept -p hkt-chain                    -- tests::simple_chain::build_chain
    //     cargo insta test --accept -p hkt-chain --features nightly -- tests::simple_chain::build_chain
