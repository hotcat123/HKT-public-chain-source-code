...
use hkt_client_primitives::debug::{ApprovalAtHeightStatus, ApprovalHistoryEntry};
...
use hkt_primitives::types::{AccountId, ApprovalStake, Balance, BlockHeight, BlockHeightDelta};
...
mod tests {
    ...
    use hkt_primitives::time::Clock;
    use hkt_primitives::types::ApprovalStake;
