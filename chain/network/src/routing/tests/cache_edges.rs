...
use hkt_network_primitives::types::Edge;
use hkt_network_primitives::types::EDGE_MIN_TIMESTAMP_NONCE;
...
struct RoutingTableTest {
    ...
    db: Arc<dyn hkt_store::db::Database>,
...
impl RoutingTableTest {
    ...
    fn new() -> Self {
        ...
        let db = hkt_store::db::TestDB::new();
