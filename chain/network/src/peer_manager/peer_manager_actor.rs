...
use hkt_network_primitives::types::{EdgeState, PartialEdgeInfo};
...
pub struct PeerManagerActor {
    ...
    /// A graph of the whole hkt network, shared between routing::Actor
    ...
    /// generic threadpool (or multiple pools) in the hkt-network crate.
