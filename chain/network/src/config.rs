...
use hkt_network_primitives::types::{Blacklist, PeerInfo, ROUTED_MESSAGE_TTL};
...
mod test {
    ...
    use hkt_network_primitives::time;
    use hkt_network_primitives::types::UPDATE_INTERVAL_LAST_TIME_RECEIVED_MESSAGE;
