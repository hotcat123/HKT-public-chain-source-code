...
use hkt_primitives::block::{Approval, ApprovalMessage, Block, BlockHeader, GenesisId};
use hkt_primitives::challenge::Challenge;
...
use hkt_primitives::sharding::{PartialEncodedChunk, PartialEncodedChunkWithArcReceipts};
use hkt_primitives::syncing::{EpochSyncFinalizationResponse, EpochSyncResponse};
use hkt_primitives::transaction::SignedTransaction;
use hkt_primitives::types::BlockHeight;
use hkt_primitives::types::{AccountId, EpochId, ShardId};
use hkt_primitives::views::{KnownProducerView, NetworkInfoView, PeerInfoView};
...
pub struct ChainInfo {
    ...
    // priority on the hkt network than other peers.
...
pub enum NetworkClientMessages {
    ...
    Adversarial(hkt_network_primitives::types::NetworkAdversarialMessage),
...
mod tests {
    ...
    // NOTE: this has it's counterpart in `hkt_network_primitives::types::tests`
