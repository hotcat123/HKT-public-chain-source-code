...
Scheduled runs can be seen at <https://nayduck.hkt.org/>.

See README.md in nightly directory for documentation of the test suite file
format.  Note that you must be a member of the hkt or hkt Protocol
organisation on GitHub to authenticate (<https://github.com/orgs/hkt/people>).

The source code for NayDuck itself is at <https://github.com/hkt/nayduck>.
"""
...
NAYDUCK_BASE_HREF = 'https://nayduck.hkt.org'
...
def run_locally(args, tests):
    for test in tests:
        # See nayduck specs at https://github.com/hkt/nayduck/blob/master/lib/testspec.py
        fields = test.split()
