...
pub struct GenesisConfig {
    ...
    /// See <https://github.com/hkt/NEPs/pull/167> for details
...
impl From<&GenesisConfig> for EpochConfig {
    fn from(config: &GenesisConfig) -> Self {
        EpochConfig {
            ...
            validator_selection_config: hkt_primitives::epoch_manager::ValidatorSelectionConfig {
