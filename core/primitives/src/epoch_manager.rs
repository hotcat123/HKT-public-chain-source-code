...
use hkt_primitives_core::types::BlockHeight;
...
/// algorithm.  See <https://github.com/hkt/NEPs/pull/167> for details.
...
pub mod block_info {
    ...
    use borsh::{BorshDeserialize, BorshSerialize};
    use hkt_primitives_core::hash::CryptoHash;
    use hkt_primitives_core::types::{AccountId, Balance, BlockHeight, ProtocolVersion};
