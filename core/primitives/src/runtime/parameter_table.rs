use hkt_primitives_core::parameter::{FeeParameter, Parameter};
use serde_json::json;
...
mod tests {
    ...
    use hkt_primitives_core::parameter::Parameter;
    use std::collections::BTreeMap;
...
"#;
    ...
    static DIFF_0: &str = r#"
# Comment line
registrar_account_id: registrar -> hkt
...
"#;
    ...
    static DIFF_1: &str = r#"
# Comment line
registrar_account_id: hkt -> registrar
...
"#;
    ...
    fn test_parameter_table_with_diff() {
        check_parameter_table(
            ...
            &[DIFF_0],
            [
                (Parameter::RegistrarAccountId, "\"hkt\""),
