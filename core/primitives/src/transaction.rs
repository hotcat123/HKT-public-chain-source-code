...
mod tests {
    ...
    use hkt_crypto::{InMemorySigner, KeyType, Signature, Signer};
    ...
    /// If it does - you MUST update all of the dependencies: like hktlib and other clients.
    #[test]
    fn test_serialize_transaction() {
        let public_key: PublicKey = "22skMptHjFWNyuEWY22ftn2AbLPSYpmYwGJRGwpNHbTV".parse().unwrap();
        let transaction = Transaction {
            signer_id: "test.hkt".parse().unwrap(),
