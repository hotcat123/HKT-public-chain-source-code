...
/// See [NEP 71](https://github.com/hktprotocol/NEPs/pull/71)
...
pub enum ProtocolFeature {
    ...
    /// <https://github.com/hkt/hktcore/issues/3779>.
    AccessKeyNonceRange,
    FixApplyChunks,
    LowerStorageCost,
    ...
    /// <https://github.com/hkt/hktcore/pull/4954> for more details.
    LimitContractFunctionsNumber,
    BlockHeaderV3,
    /// Changes how we select validators for epoch and how we select validators
    /// within epoch.  See <https://github.com/hkt/NEPs/pull/167> for general
...
/// <https://github.com/hkt/NEPs/issues/205>
