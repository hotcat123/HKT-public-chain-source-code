...
pub struct BlockV1 {
    ...
    pub vrf_value: hkt_crypto::vrf::Value,
    pub vrf_proof: hkt_crypto::vrf::Proof,
}
...
impl Block {
    fn block_from_protocol_version(
        ...
        vrf_value: hkt_crypto::vrf::Value,
        vrf_proof: hkt_crypto::vrf::Proof,
    ) -> Block {
    ...
    pub fn genesis(
        ...
        let vrf_value = hkt_crypto::vrf::Value([0; 32]);
        let vrf_proof = hkt_crypto::vrf::Proof([0; 64]);
    ...
    #[inline]
    pub fn vrf_value(&self) -> &hkt_crypto::vrf::Value {
        match self {
    ...
    #[inline]
    pub fn vrf_proof(&self) -> &hkt_crypto::vrf::Proof {
        match self {
