...
pub enum DBCol {
    ...
    /// - *Content type*: [hkt_primitives::block::Block]
    Block,
    /// Column that stores Block headers.
    /// - *Rows*: block hash (CryptoHash)
    /// - *Content type*: [hkt_primitives::block_header::BlockHeader]
    BlockHeader,
    ...
    /// - *Content type*: [hkt_primitives::types::chunk_extra::ChunkExtra]
    ChunkExtra,
    ...
    /// - *Content type*: Vec of [hkt_primitives::transaction::ExecutionOutcomeWithIdAndProof]
    TransactionResult,
    /// Mapping from Block + Shard to list of outgoing receipts.
    /// - *Rows*: block + shard
    /// - *Content type*: Vec of [hkt_primitives::receipt::Receipt]
    OutgoingReceipts,
    /// Mapping from Block + Shard to list of incoming receipt proofs.
    /// Each proof might prove multiple receipts.
    /// - *Rows*: (block, shard)
    /// - *Content type*: Vec of [hkt_primitives::sharding::ReceiptProof]
    IncomingReceipts,
    ...
    /// - *Content type*: [hkt_primitives::epoch_manager::epoch_info::EpochInfo]
    EpochInfo,
    /// Mapping from BlockHash to BlockInfo
    /// - *Rows*: BlockHash (CryptoHash)
    /// - *Content type*: [hkt_primitives::epoch_manager::block_info::BlockInfo]
    BlockInfo,
    /// Mapping from ChunkHash to ShardChunk.
    /// - *Rows*: ChunkHash (CryptoHash)
    /// - *Content type*: [hkt_primitives::sharding::ShardChunk]
    Chunks,
    /// Storage for  PartialEncodedChunk.
    /// - *Rows*: ChunkHash (CryptoHash)
    /// - *Content type*: [hkt_primitives::sharding::PartialEncodedChunk]
    PartialChunks,
    ...
    /// - *Rows*: nonce
    /// - *Column type*: `Vec<hkt_network::routing::Edge>`
    ComponentEdges,
    ...
    /// - *Column type*: hkt-vm-runner CacheRecord
    CachedContractCode,
