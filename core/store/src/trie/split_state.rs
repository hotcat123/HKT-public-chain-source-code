...
use hkt_primitives::trie_key::trie_key_parsers::parse_account_id_from_raw_key;
...
mod tests {
    ...
    use hkt_primitives::borsh::BorshSerialize;
    use hkt_primitives::hash::{hash, CryptoHash};
    use hkt_primitives::receipt::{DelayedReceiptIndices, Receipt};
    use hkt_primitives::state_part::PartId;
    use hkt_primitives::trie_key::trie_key_parsers::parse_account_id_from_raw_key;
    use hkt_primitives::trie_key::TrieKey;
    use hkt_primitives::types::{
