...
pub struct AccessKey {
    ...
    /// See <https://github.com/hkt/hktcore/issues/3779> for more details.
    pub nonce: Nonce,
...
pub struct FunctionCallPermission {
    ...
    // values for this field (see: https://github.com/hkt/hktcore/pull/4621#issuecomment-892099860)
