...
fn get_c_memory_usage_cur_thread() -> ByteSize {
    ...
    // This feature will only work if hkt is started with environment
    // LD_PRELOAD=${PWD}/bins/hkt-c-allocator-proxy.so hktup ...
    // from https://github.com/hkt/hkt-memory-tracker/blob/master/hkt-dump-analyzer
