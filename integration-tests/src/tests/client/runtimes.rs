...
use hkt_chunks::test_utils::ChunkTestFixture;
use hkt_chunks::ProcessPartialEncodedChunkResult;
use hkt_client::test_utils::TestEnv;
use hkt_crypto::KeyType;
use hkt_network::test_utils::MockPeerManagerAdapter;
use hkt_network_primitives::types::PartialEncodedChunkForwardMsg;
...
use hkt_primitives::sharding::ShardChunkHeaderInner;
use hkt_primitives::sharding::{PartialEncodedChunk, ShardChunkHeader};
...
fn test_process_partial_encoded_chunk_with_missing_block() {
    ...
    assert_matches!(
        result.unwrap_err(),
        hkt_client_primitives::types::Error::Chunk(hkt_chunks::Error::UnknownChunk)
    );
}
