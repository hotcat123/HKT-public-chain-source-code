...
use crate::user::User;
use actix::System;
use hkt_jsonrpc_client::new_client;
    ...
    fn start(&mut self) {
        match self.state {
            ProcessNodeState::Stopped => {
                ...
                hkt_actix_test_utils::run_actix(async move {
...
impl ProcessNode {
    ...
    pub fn new(config: hktConfig) -> ProcessNode {
