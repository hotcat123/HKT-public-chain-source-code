...
use hkt_epoch_manager::EpochManagerHandle;
use hkt_primitives::errors::EpochError;
...
impl ShardTracker {
    ...
    pub fn care_about_shard(
        ...
        // https://github.com/hkt/hktcore/issues/4936
...
mod tests {
    ...
    use hkt_epoch_manager::test_utils::hash_range;
    use hkt_epoch_manager::{EpochManager, EpochManagerHandle, RewardCalculator};
    use hkt_primitives::epoch_manager::block_info::BlockInfo;
    use hkt_primitives::epoch_manager::{AllEpochConfig, EpochConfig};
    use hkt_primitives::hash::CryptoHash;
    use hkt_primitives::shard_layout::ShardLayout;
    use hkt_primitives::types::validator_stake::ValidatorStake;
    use hkt_primitives::types::{BlockHeight, EpochId, NumShards, ProtocolVersion, ShardId};
    ...
    fn test_track_shards_shard_layout_change() {
        ...
        let tracked_accounts = vec!["hkt".parse().unwrap(), "zoo".parse().unwrap()];
