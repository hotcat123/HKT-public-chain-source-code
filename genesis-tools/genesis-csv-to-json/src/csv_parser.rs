...
use hkt_primitives::account::{AccessKey, AccessKeyPermission, Account, FunctionCallPermission};
...
use hkt_primitives::transaction::{Action, FunctionCallAction};
use hkt_primitives::types::{AccountId, AccountInfo, Balance, Gas};
    ...
    fn test_with_file() {
        ...
        writer
            .serialize(Row {
                ...
                account_id: "alice_hkt".parse().unwrap(),
                regular_pks: vec![
        ...
        writer
            .serialize(Row {
                genesis_time: None,
                account_id: "bob_hkt".parse().unwrap(),
                regular_pks: vec![],
                privileged_pks: vec![PublicKey::empty(KeyType::ED25519)],
                foundation_pks: vec![PublicKey::empty(KeyType::ED25519)],
                full_pks: vec![],
