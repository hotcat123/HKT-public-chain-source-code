use crate::hkt_primitives::version::PROTOCOL_VERSION;
...
use hkt_store::{get_access_key, get_account, get_code, TrieUpdate};
use hkt_vm_logic::{ReturnData, ViewConfig};
        ...
        let access_keys =
            state_update
                ...
                .map(|key| {
                    ...
                    let access_key = hkt_store::get_access_key_raw(state_update, &key)?
