...
pub enum ViewAccountError {
    ...
    InvalidAccountId { requested_account_id: hkt_primitives::types::AccountId },
    #[error("Account ID #{requested_account_id} does not exist")]
    AccountDoesNotExist { requested_account_id: hkt_primitives::types::AccountId },
...
pub enum ViewContractCodeError {
    ...
    NoContractCode { contract_account_id: hkt_primitives::types::AccountId },
    #[error("Internal error: #{error_message}")]
    InternalError { error_message: String },
}
...
pub enum ViewAccessKeyError {
    ...
    AccessKeyDoesNotExist { public_key: hkt_crypto::PublicKey },
    #[error("Internal error: #{error_message}")]
    InternalError { error_message: String },
}
...
pub enum ViewStateError {
    ...
    AccountStateTooLarge { requested_account_id: hkt_primitives::types::AccountId },
    #[error("Internal error: #{error_message}")]
    InternalError { error_message: String },
}
...
impl From<hkt_primitives::errors::StorageError> for ViewAccountError {
    fn from(storage_error: hkt_primitives::errors::StorageError) -> Self {
        Self::InternalError { error_message: storage_error.to_string() }
    }
}

impl From<hkt_primitives::errors::StorageError> for ViewContractCodeError {
    fn from(storage_error: hkt_primitives::errors::StorageError) -> Self {
        Self::InternalError { error_message: storage_error.to_string() }
    }
}

impl From<hkt_primitives::errors::StorageError> for ViewAccessKeyError {
    fn from(storage_error: hkt_primitives::errors::StorageError) -> Self {
        Self::InternalError { error_message: storage_error.to_string() }
    }
}

impl From<hkt_primitives::errors::StorageError> for ViewStateError {
    fn from(storage_error: hkt_primitives::errors::StorageError) -> Self {
        Self::InternalError { error_message: storage_error.to_string() }
    }
}

impl From<hkt_primitives::errors::StorageError> for CallFunctionError {
    fn from(storage_error: hkt_primitives::errors::StorageError) -> Self {
        Self::InternalError { error_message: storage_error.to_string() }
    }
}
