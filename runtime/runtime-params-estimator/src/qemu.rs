...
impl QemuCommandBuilder {
    ...
    pub fn build(&self, inner_cmd: &str) -> anyhow::Result<Command> {
        let mut cmd = Command::new(
            "/host/hktcore/runtime/runtime-params-estimator/emu-cost/counter_plugin/qemu-x86_64",
        );

        let plugin_path =
            "/host/hktcore/runtime/runtime-params-estimator/emu-cost/counter_plugin/libcounter.so";
