...
pub enum Cost {
    ...
    /// compilation cost. Instead of least-squares method, it finds a lihkt
    ...
    /// contracts. The smallest contract is taken as the first anchor the lihkt
