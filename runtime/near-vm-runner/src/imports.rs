      ...
      $($(#[$stable_feature:ident])? $(#[$feature_name:literal, $feature:ident])* $(##[$feature_name2:literal])?
        ...
        macro_rules! for_each_available_import {
            ($protocol_version:expr, $M:ident) => {$(
                ...
                if true
                    $(&& hkt_primitives::checked_feature!($feature_name, $feature, $protocol_version))*
                    $(&& hkt_primitives::checked_feature!("stable", $stable_feature, $protocol_version))?
                {
...
pub(crate) mod wasmer {
    use super::str_eq;
    use hkt_vm_logic::{ProtocolVersion, VMLogic, VMLogicError};
    use std::ffi::c_void;
...
pub(crate) mod wasmer2 {
    ...
    use super::str_eq;
    use hkt_vm_logic::{ProtocolVersion, VMLogic};
                ...
                (
                  ...
                  >
                    ...
                    -> Ret {
                        ...
                        let result: Result<Result<_, hkt_vm_errors::VMLogicError>, _>  = result;
                        #[allow(unused_parens)]
                        match result {
...
pub(crate) mod wasmtime {
    ...
    pub(crate) fn last_error() -> Option<hkt_vm_logic::VMLogicError> {
