...
use hkt_vm_logic::{External, VMContext, VMLogic, VMLogicError};
    ...
    fn into_vm_error(self) -> VMError {
        ...
        match self {
            RuntimeError::InvokeError(invoke_error) => match invoke_error {
                ...
                //
                // See https://github.com/hkt/wasmer/blob/0.17.2/lib/runtime-core/src/fault.rs#L285
                InvokeError::FailedWithNoError => {
                    ...
                    VMError::FunctionCallError(
                        ...
                        //
                        // Then, in
                        // https://github.com/hkt/hktcore/pull/4181#discussion_r606267838
