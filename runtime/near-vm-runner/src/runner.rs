...
use hkt_vm_errors::VMError;
use hkt_vm_logic::types::PromiseResult;
use hkt_vm_logic::{External, ReturnData, VMContext, VMLogic, VMOutcome};

use crate::vm_kind::VMKind;

/// Validate and run the specified contract.
///
/// This is the entry point for executing a hkt protocol contract. Before the
...
pub trait VM {
    /// Validate and run the specified contract.
    ///
    /// This is the entry point for executing a hkt protocol contract. Before
