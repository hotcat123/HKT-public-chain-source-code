...
use hkt_vm_errors::{CacheError, CompilationError};
use hkt_vm_logic::{ProtocolVersion, VMConfig};
...
use crate::prepare;
#[cfg(target_arch = "x86_64")]
use hkt_vm_errors::{FunctionCallError, VMError};
...
static WASMER_CACHE: once_cell::sync::Lazy<
    hkt_cache::SyncLruCache<CryptoHash, Result<wasmer_runtime::Module, CompilationError>>,
> = once_cell::sync::Lazy::new(|| hkt_cache::SyncLruCache::new(CACHE_SIZE));

#[cfg(all(feature = "wasmer2_vm", not(feature = "no_cache"), target_arch = "x86_64"))]
static WASMER2_CACHE: once_cell::sync::Lazy<
    hkt_cache::SyncLruCache<
        CryptoHash,
...
pub mod wasmer0_cache {
    use super::*;
    use hkt_vm_errors::CompilationError;
