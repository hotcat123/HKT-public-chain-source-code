...
use hkt_primitives_core::config::ExtCosts::read_cached_trie_node;
use hkt_primitives_core::config::ExtCosts::touching_trie_node;
use hkt_primitives_core::runtime::fees::Fee;
use hkt_primitives_core::{
...
impl GasCounter {
    ...
    pub fn process_gas_limit(&mut self, new_burnt_gas: Gas, new_used_gas: Gas) -> HostError {
        ...
        // See https://github.com/hkt/hktcore/issues/5148.
