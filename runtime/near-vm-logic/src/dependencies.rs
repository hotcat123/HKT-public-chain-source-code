//! External dependencies of the hkt-vm-logic.

use hkt_primitives::hash::CryptoHash;
use hkt_primitives::types::TrieNodesCount;
use hkt_primitives_core::types::{AccountId, Balance};
use hkt_vm_errors::VMLogicError;
...
pub trait External {
    ...
    /// # Errors
    ///
    /// This function could return [`hkt_vm_errors::VMError::ExternalError`].
    ///
    /// # Example
    /// ```
    /// # use hkt_vm_logic::mocks::mock_external::MockedExternal;
    ...
    /// # Errors
    ///
    /// This function could return [`hkt_vm_errors::VMError`].
    ///
    /// # Example
    /// ```
    /// # use hkt_vm_logic::mocks::mock_external::MockedExternal;
