...
use hkt_primitives_core::config::ViewConfig;

pub fn get_context(input: Vec<u8>, is_view: bool) -> VMContext {
    VMContext {
        current_account_id: "alice.hkt".parse().unwrap(),
        signer_account_id: "bob.hkt".parse().unwrap(),
        signer_account_pk: vec![0, 1, 2],
        predecessor_account_id: "carol.hkt".parse().unwrap(),
        input,
        block_index: 0,
        block_timestamp: 0,
        epoch_height: 0,
