...
def upload_to_s3(file_lines: list, account: str) -> str:
    """
    Upload File like object to S3 bucket hkt-protocol-validator-logs-public.
    file_obj: io.BytesIO
    account: str
    return string with S3 file path
    """
    BUCKET = "hkt-protocol-validator-logs-public"
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Send logs to hkt.')
