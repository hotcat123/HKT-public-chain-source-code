 ...
 * ChunkExtra versions in database and produced by `hktd` playback. Consider them equal as
...
mod test {
    ...
    use hkt_primitives::types::{BlockHeight, BlockHeightDelta, NumBlocks};
