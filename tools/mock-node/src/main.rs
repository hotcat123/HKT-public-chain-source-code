...
use hkt_client::{GetBlock, Status};
...
fn main() -> anyhow::Result<()> {
    ...
    let mut hkt_config = hktcore::config::load_config(home_dir, GenesisValidationMode::Full)
