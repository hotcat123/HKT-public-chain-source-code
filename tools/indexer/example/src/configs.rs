...
use hkt_indexer::hkt_primitives::types::Gas;

/// hkt Indexer Example
/// Watches for stream of blocks from the chain
#[derive(Parser, Debug)]
#[clap(version = "0.1", author = "hkt Inc. <hello@hktprotocol.com>")]
#[clap(subcommand_required = true, arg_required_else_help = true)]
pub(crate) struct Opts {
    /// Sets a custom config dir. Defaults to ~/.hkt/
    #[clap(short, long)]
...
pub(crate) enum SubCommand {
    /// Run hkt Indexer Example. Start observe the network
    Run,
...
impl From<InitConfigArgs> for hkt_indexer::InitConfigArgs {
